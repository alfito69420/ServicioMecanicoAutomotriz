...
class CitaCliente extends datosBase
{
    function lista()
    {
        ...
        for ($ren = 0; $ren < $this->numeRegistros; $ren++) {
            ...
            <td>
                        <form method="post" action="../regular_user/mis_citas.php")">
                    ...
                    <td>
                        <form method="post" action="../regular_user/mis_citas.php" onsubmit="return confirm(\'Estas seguro?\')">
    ...
    function ejecuta($p_accion, $p_id = 0)
    {
        ...
        switch ($p_accion) {
            ...
            case 'insert';
                ...
                $query3 = "INSERT INTO cita SET fecha_cita='" . $_POST['fechaCita'] . "WHERE id_cita=" . $_POST['id'];
            ...
            case 'update':
                ...
                //var_dump($_POST['fechaCita']);
                //var_dump($_POST['id']);
                $this->consulta($query2);
                return $this->lista();
                break;
            default:
                $html = $p_accion . "No está programada en classCita";
        }
        return $html;
    } //close function
}
$objeCitaCliente = new CitaCliente();
